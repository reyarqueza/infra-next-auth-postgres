...
### Step 3. Complete the prerequisites above (GitHub CLI, Neon MCP, Vercel CLI, Cloudflare token, and Vercel ↔ GitHub).
### Step 4. In the Cursor prompt, set your model to **Composer 2.5 Fast** and type or say:
...
```
  ...
  | --------------------- | --------------- | --------------------------------------------------------- |
  | `APP_NAME`            | *(required)*    | GitHub repo name and package name                         |
...
### Step 6. Work in the generated app at `LOCAL_PATH` (separate from this skills repo).
